...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "英国api.cc", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "英国api.cc", "https://example.com/reset", "en-US"))
...
func (s *notificationEmailTestSMTPServer) settings() map[string]string {
	...
	return map[string]string{
		...
		SettingKeySMTPFromName: "英国api.cc",
