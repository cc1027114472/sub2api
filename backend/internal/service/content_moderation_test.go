...
func TestContentModerationUpdateConfig_AppendsAndDeletesAPIKeys(t *testing.T) {
	...
	svc := NewContentModerationService(repo, nil, nil, nil, nil, nil,
		nil, nil, nil)
...
func TestContentModerationCallModeration_400DoesNotFreezeAPIKey(t *testing.T) {
	...
	cfg.APIKeys = []string{"sk-test"}
	cfg.RetryCount = 5
	svc := NewContentModerationService(nil, nil, nil, nil, nil, nil,
		nil, nil, nil)
...
func TestContentModerationAutoBanSkipsAdminAccount(t *testing.T) {
	...
	svc := NewContentModerationService(nil, repo, nil, nil, userRepo, nil,
		nil, invalidator, nil)
...
func TestContentModerationUpdateConfig_CyberPolicyExcludeFromBanCount(t *testing.T) {
	settingRepo := &contentModerationTestSettingRepo{values: map[string]string{}}
	svc := NewContentModerationService(settingRepo, nil, nil, nil, nil, nil,
		nil, nil, nil)
