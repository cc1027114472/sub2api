...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	channelQuickSyncService := service.ProvideChannelQuickSyncService(configConfig, pricingService, billingService, accountTestService, accountRepository, groupRepository, channelRepository, client, channelService, channelService)
