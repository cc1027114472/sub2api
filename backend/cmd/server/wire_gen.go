...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	contentModerationService := service.NewContentModerationService(settingRepository, contentModerationRepository, contentModerationHashCache, groupRepository, userRepository, proxyRepository, apiKeyRepository, apiKeyAuthCacheInvalidator, emailService)
	...
	channelQuickSyncService := service.ProvideChannelQuickSyncService(configConfig, pricingService, billingService, accountTestService, accountRepository, groupRepository, channelRepository, client, channelService, channelService, channelMonitorService)
