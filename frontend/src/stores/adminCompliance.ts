...
const FALLBACK_ZH_PHRASE = '我已阅读、理解并同意 英国api.cc 部署与运营合规承诺'
const FALLBACK_EN_PHRASE = 'I have read, understood, and agree to the 英国api.cc Deployment and Operation Compliance Commitment'
