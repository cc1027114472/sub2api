export default {
    ...
    channels: {
      ...
      quickSync: {
        button: '一键同步节点',
        modalTitle: '一键同步节点与多协议配置向导',
        step1: '1. 连接与探测',
        step2: '2. 分组与计费配置',
        step3: '3. 确认与导入',
        channelName: '节点名称',
        channelNamePlaceholder: '例如：Antigravity-Node-1',
        baseUrl: '基础接口地址 (Base URL)',
        baseUrlPlaceholder: 'http://127.0.0.1:8080 或上游 API 接口 URL',
        apiKey: 'API 密钥 (API Key)',
        apiKeyPlaceholder: 'sk-... 或上游访问令牌',
        platform: '平台类型',
        platformHelp: '选择 antigravity 将自动适配 Gemini、OpenAI、Claude 与 Codex 协议。',
        groupConfig: '目标分组配置',
        defaultGroup: '默认归属分组',
        newGroupDefault: '新建独立分组',
        createNewGroup: '新建独立分组',
        newGroupName: '新分组名称',
        newGroupNamePlaceholder: '输入新分组名称',
        newGroupMultiplier: '新分组费率倍率',
        billingStrategy: '计费策略设定',
        ratioMode: '倍率计费模式',
        perRequestMode: '按次计费模式',
        customMode: '自定义调整',
        multiplierLabel: '基准倍率:',
        ratioHint: '自动按倍率更新各模型输入/输出价格',
        perReqPriceLabel: '单次费用 ($):',
        perReqHint: '将所有模型设置为按次计费',
        modelListTitle: '探测模型列表',
        batchActions: '批量操作:',
        selectGroup: '选择目标分组',
        applyGroup: '移动到分组',
        setTokenMode: '设为按Token',
        setPerReqMode: '设为按次',
        batchGroupApplied: '已批量设置所选模型分组',
        modelName: '模型 ID',
        targetGroup: '归属分组',
        billingMode: '计费模式',
        inputPrice: '输入价 ($/1M)',
        outputPrice: '输出价 ($/1M)',
        perReqPrice: '按次单价 ($)',
        summaryChannel: '节点与凭据配置',
        summaryGroups: '目标分组与模型统计',
        newGroupAction: '新建分组',
        totalModelsCount: '模型总数',
        billingBreakdown: '计费模式分布',
        groupBreakdown: '各分组包含模型明细',
        probeFailed: '探测失败，请检查 Base URL 与 API Key 是否正确',
        probing: '正在探测...',
        probeButton: '测试连接并探测模型',
        nextConfirm: '下一步：确认导入',
        committing: '正在导入...',
        commitButton: '确认导入',
        commitSuccess: '一键同步节点配置成功！',
