export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description: '配置 Grok Build、Claude Code、Codex 或 OpenCode，让请求通过当前 英国api.cc Grok 分组发送。',
        ...
        codexNote: '将 config.toml 保存到 ~/.codex，并在启动 Codex 前设置 GATEWAY_API_KEY。',
        codexNoteWindows: '将 config.toml 保存到 %USERPROFILE%\\.codex，并在 PowerShell 中设置 GATEWAY_API_KEY 后启动 Codex。'
      },
      opencode: {
        title: 'OpenCode 配置示例',
