export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description: 'Configure Grok Build, Claude Code, Codex, or OpenCode to send requests through your 英国api.cc Grok group.',
        ...
        codexNote: 'Save config.toml under ~/.codex and set GATEWAY_API_KEY before starting Codex.',
        codexNoteWindows: 'Save config.toml under %USERPROFILE%\\.codex and set GATEWAY_API_KEY in PowerShell before starting Codex.',
      },
      opencode: {
