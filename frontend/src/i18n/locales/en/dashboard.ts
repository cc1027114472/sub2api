export default {
  ...
  keys: {
    ...
    importToMowan: 'Import to mowan-harness',
    enable: 'Enable',
    disable: 'Disable',
    nameLabel: 'Name',
    ...
    useKeyModal: {
      ...
      grok: {
        description:
          'Configure Grok CLI, Claude Code, Codex, or OpenCode to send requests through your 英国api.cc Grok group. Text models use Responses; image/video use Imagine model IDs on media endpoints.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your 英国api.cc Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your 英国api.cc Grok group.',
        configTomlHint:
        ...
        codexConfigTomlHint:
          'Official Codex: wire_api = "responses" only; prefer env_key over experimental_bearer_token; supports_websockets = false for non-OpenAI gateways (英国api.cc can still accept client WS and bridge to HTTP/SSE). Back up ~/.codex/config.toml before merge.',
        note:
  ...
  agentDownload: {
    ...
    fileSize: 'File Size',
    envIncluded: 'Embedded standalone runtime included. No need to install Node.js or configure environments manually.',
    downloadPrimary: 'Download Windows Setup (.exe)',
    downloadPortable: 'Download Portable Version (.zip)',
    detectedPlatform: 'Matched to your OS:',
    manualSelect: 'Or choose another platform',
    windowsTitle: 'Windows Client',
    windowsDesc: 'Compatible with Windows 10 / 11 64-bit. One-click setup with desktop shortcuts.',
    windowsInstaller: 'Standard Installer (Setup.exe)',
    windowsPortable: 'Portable Version (.zip)',
    macTitle: 'macOS Client',
    macDesc: 'Compatible with Apple Silicon (M1/M2/M3/M4) and Intel architectures.',
    macComingSoon: 'Ready / Coming Soon',
    linuxTitle: 'Linux / Geek Mode',
    ...
    apiKeySelect: 'Select your API Key',
    noKeyHint: 'No active API Key found. Click to create one.',
    createKeyBtn: 'Manage API Keys',
    loginPrompt: 'Sign in to automatically link your API keys and generate connection configs in seconds.',
