export default {
    ...
    channels: {
      ...
      quickSync: {
        button: 'Quick Sync Node',
        modalTitle: 'Channel Quick Sync & Multi-Protocol Wizard',
        step1: '1. Connect & Probe',
        step2: '2. Group & Pricing Config',
        step3: '3. Confirm & Import',
        channelName: 'Channel Name',
        channelNamePlaceholder: 'e.g. Antigravity-Node-1',
        baseUrl: 'Base URL',
        baseUrlPlaceholder: 'http://127.0.0.1:8080 or upstream API URL',
        apiKey: 'API Key',
        apiKeyPlaceholder: 'sk-... or upstream token',
        platform: 'Platform',
        platformHelp: 'Selecting antigravity automatically bridges Gemini, OpenAI, Claude, and Codex protocols.',
        groupConfig: 'Target Group Configuration',
        defaultGroup: 'Default Target Group',
        newGroupDefault: 'New Independent Group',
        createNewGroup: 'Create New Group',
        newGroupName: 'New Group Name',
        newGroupNamePlaceholder: 'Enter new group name',
        newGroupMultiplier: 'New Group Rate Multiplier',
        billingStrategy: 'Billing Strategy',
        ratioMode: 'Multiplier Mode',
        perRequestMode: 'Per-Request Mode',
        customMode: 'Custom Adjustment',
        multiplierLabel: 'Base Multiplier:',
        ratioHint: 'Automatically updates model input/output prices by multiplier',
        perReqPriceLabel: 'Price Per Request ($):',
        perReqHint: 'Sets all models to per-request billing',
        modelListTitle: 'Discovered Models',
        batchActions: 'Batch Actions:',
        selectGroup: 'Select Target Group',
        applyGroup: 'Move to Group',
        setTokenMode: 'Set to Token',
        setPerReqMode: 'Set to Per-Request',
        batchGroupApplied: 'Batch updated target group for selected models',
        modelName: 'Model ID',
        targetGroup: 'Target Group',
        billingMode: 'Billing Mode',
        inputPrice: 'Input Price ($/1M)',
        outputPrice: 'Output Price ($/1M)',
        perReqPrice: 'Per-Request Price ($)',
        summaryChannel: 'Channel & Credentials',
        summaryGroups: 'Target Groups & Stats',
        newGroupAction: 'New Group',
        totalModelsCount: 'Total Models',
        billingBreakdown: 'Billing Mode Breakdown',
        groupBreakdown: 'Models Breakdown by Group',
        ...
        probing: 'Probing...',
        probeButton: 'Test Connection & Probe Models',
        nextConfirm: 'Next: Confirm & Import',
        committing: 'Importing...',
        commitButton: 'Confirm & Import',
        commitSuccess: 'Quick sync channel configured successfully!',
