export default {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. api-backups), choose a region',
    ...
    groups: {
      ...
      openaiLive: {
        ...
        hint: 'When enabled, API keys in this OpenAI group can create and control Live voice sessions. Disabled by default. The 英国api.cc server must run on Apple Silicon macOS with the official ChatGPT app installed; client platforms are unrestricted.',
        unsupportedTitle: 'Current server does not support Live',
        unsupportedMessage: 'This 英国api.cc server cannot generate the required Live attestation. Live will not work even if enabled. Continue anyway?',
