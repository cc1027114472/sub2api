export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for 英国api.cc end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for 英国api.cc end-user login',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve rates declared by upstream relay sites. Account rates change only when the separate sync switch is enabled.',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on 英国api.cc orders; the upstream type is sent as EasyPay type.',
