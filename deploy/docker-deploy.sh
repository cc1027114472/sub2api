...
main() {
    ...
    echo "=========================================="
    echo ""
    echo "Generated secure credentials have been written to .env (mode 600)."
    echo "  Secrets: POSTGRES_PASSWORD, JWT_SECRET, TOTP_ENCRYPTION_KEY"
    echo "  Open .env locally to copy values — they are NOT printed here."
    echo ""
    print_warning "Keep the .env file secure and do not share it publicly!"
    echo ""
